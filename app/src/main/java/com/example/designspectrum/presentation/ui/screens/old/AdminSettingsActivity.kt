...
import com.example.designspectrum.presentation.ui.screens.old.products.ShowProductActivity
import com.example.designspectrum.presentation.viewmodels.ProductViewModel
...
class AdminSettingsActivity : AppCompatActivity() {
    ...
    private fun uploadImage() {
        ...
        val task = up.continueWithTask { _ ->
            mRefer.downloadUrl
